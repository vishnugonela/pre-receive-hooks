...
# Name: ctg-eium-sf-pre-commit-check.sh
# Description:  Script is used to eIUM SF GIT hooks to validate commit messages 
# Organization Unit: CTG
# Author: vishnug@hpe.com
# Team: eIUM SF

DEBUG=0
QXCR_RE="QXCR[0-9]{10}([^0-9].*)?$"
JIRA_RE="CMSEIUMSF-[0-9]+"
